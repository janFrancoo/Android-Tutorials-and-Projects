...
public class UploadActivity extends AppCompatActivity {
    ...
    public void upload(View view) {
        ...
        chosenImg.compress(Bitmap.CompressFormat.PNG, 50, byteArrayOutputStream);
        ...
        if(requestCode == 2 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                if(Build.VERSION.SDK_INT >= 28) {
                    ...
                    chosenImg = ImageDecoder.decodeBitmap(source);
                    img.setImageBitmap(chosenImg);
                } else {
                    chosenImg = MediaStore.Images.Media.getBitmap(this.getContentResolver(),
                            imgData);
                    img.setImageBitmap(chosenImg);
                }
            } catch (IOException e) {
